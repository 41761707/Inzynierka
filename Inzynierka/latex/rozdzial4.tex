...
\section{Implementacja algorytmu}
    ...
    \begin{figure}[H]
        \label{PetlaGlowna}
        \includegraphics[scale=0.5]{GRAPHPLAN_petla_glowna}
        \centering
    ...
    Przy implementacji predykatu $actions/6$ należy zwrócić uwagę na wykorzystanie programowania ograniczeń w formie zmiennej \textbf{IA}, 
...
\section{Generowanie grafów}
    ...
    \begin{figure}
        \includegraphics[scale=0.6]{GrafPelnyGen}
        \centering
        \caption{Diagram przepływu dla generowania pojedynczego grafu pełnego}
    \end{figure}

    \begin{figure}
        \includegraphics[scale=0.75]{parseInputInDepth}
        \centering
    ...
    \begin{pseudokod}
        ...
        \label{ParsePseudokod}
    \end{pseudokod}

    Funkcja(Pseudokod: \ref{ParsePseudokod}) w zależności od aktualnej sygnatury zmienia swoje działanie. Należy zauważyć, iż wszystkie akcje, a co za tym idzie ich efekty oraz 
    ...
    \begin{figure}
        \includegraphics[scale=0.6]{UML_simplified}
        \centering
    ...
    \begin{figure}[H]
        \includegraphics[scale=0.35]{GrafProsty1}
        \centering
    ...
    \begin{figure}[H]
        \includegraphics[scale=0.35]{GrafProsty2}
        \centering
        \caption{Przykład grafu pełnego dla złożonego przypadku}
    \end{figure}
...
\section{Interfejs użytkownika}
    ...
    \begin{figure}[H]
        \includegraphics[scale=0.4]{GUIMain}
        \centering
    ...
    \begin{figure}[H]
        \includegraphics[scale=0.4]{GUI3x3Empty}
        \centering
        \caption{Widok po wybraniu opcji "3x3"}
    \end{figure}

    \begin{figure}[H]
        \includegraphics[scale=0.4]{CargoBOTEmpty}
        \centering
    ...
    \begin{figure}[H]
        \includegraphics[scale=0.4]{GUI3x3Wypelnianie}
        \centering
        \caption{Proces definiowania świata}
    \end{figure}

    \begin{figure}[H]
        \includegraphics[scale=0.4]{GUI3x3Wynik}
        \centering
...
\section{Uruchomienie algorytmu z linii komend}
    ...
    \begin{figure}[H]
        \includegraphics[scale=0.7]{LiniaKomendWywolanie}
        \centering
